...
import AdminLowInventoryWidget from "@/app/_components/Admin/AdminLowInventoryWidget";
...
export default function AdminPage() {
  ...
  if (getServicesIsLoading || getAppointmentsIsLoading) {
    return (
